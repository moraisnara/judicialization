...
\small
Beyond the top-two gap, three measures read concentration across the \emph{whole} field: the effective number of candidates \ns{\citep{laakso1979}}, the vote-share Herfindahl, and the combined top-two share. Same headline spec (2024 level on the 2016 baseline, state FE, clustered by state).
\smallskip
\begin{center}
\scriptsize
