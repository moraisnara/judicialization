...
\begin{itemize}\itemsep1pt
  ...
  \item \hypertarget{src:fd}{}ANCOVA is preferred to first differences because municipal outcomes barely persist. First differences pin $\lambda=1$, over-differencing and attenuating the estimate, so FD serves as an appendix check \hyperlink{app:fd}{\beamergotobutton{FD bracket}}. Outcomes with no clean 2016 analog remain in FD.
