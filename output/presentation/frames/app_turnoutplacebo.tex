...
\end{center}
\smallskip
\footnotesize The coefficient is statistically indistinguishable from zero, so the placebo passes. Outcome is the 2024 turnout rate controlling for the 2016 level; state (UF) FE; SEs clustered by state.\hfill\hyperlink{src:voterballot}{\beamerreturnbutton{Back}}
\end{frame}
