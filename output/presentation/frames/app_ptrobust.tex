...
\end{center}
\smallskip
\footnotesize The estimates are essentially unchanged. The top-two margin barely moves from its headline value ($\MarginCoef$) and stays significant at 5\%, while effective-N and the Herfindahl shift only in the third decimal and remain imprecise, as in the headline. Conditioning on both the 2020 level and the pre-slope a municipality was on leaves the result intact, which places the consolidation as a response to the 2020$\to$2024 shock rather than the continuation of a pre-existing path. \hfill\hyperlink{src:pretrend}{\beamerreturnbutton{Back to balance test}}
\end{frame}
