...
\begin{itemize}\itemsep1pt
  ...
  \item[\textcolor{mygray}{\rule{1.2ex}{1.2ex}}] \textbf{Precise nulls.} Descriptive representation and renewal, the entrant typology, elastic and education-stratified turnout, campaign finance, and the entire legislative side are all tightly bounded around zero. The consolidation's cost belongs here as well: the runner-up's loss splits evenly by gender ($\RUGapCoef$, $p=\RUGapP$) \hyperlink{src:gender}{\beamergotobutton{gender}}.
