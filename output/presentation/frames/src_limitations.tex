...
\begin{enumerate}\itemsep4pt
  \item \textbf{Few effective shocks.} Identification rests on $K_{\text{eff}}=\KeffRotemberg$ effective shocks, with \RotPropagandaPct\% of the weight on propaganda subjects, and on \NClusters{} clusters. A many-shock law of large numbers does not apply, so the design is defended on the exogeneity of the 2020 shares (balance and pre-trend) rather than on shock count.
