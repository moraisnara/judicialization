...
\smallskip
\scriptsize\ns{This is the incidence the demographic profile of the top two implies: if winner and runner-up are near-twins , widening the margin between them should be gender-blind on the losing side, and it is. Exploratory, outside the declared family, raw $p$ .}
\end{frame}
