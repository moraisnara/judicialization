...
\footnotesize
The exogenous-shares path requires that the 2020 exposure shares isolate the \emph{adversarial} channel rather than proxy a municipality's overall litigiousness. Two checks, following \citet{borusyak2022}:
