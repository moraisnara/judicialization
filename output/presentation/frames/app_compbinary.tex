...
\end{center}
\smallskip
\footnotesize Both carry the consolidation sign, winner-majority positive and log-count negative (fewer candidates), but the binary indicator is too noisy to clear significance on its own and the raw count is only marginal. The continuous top-two margin and the effective-N count are the better-powered measurements of the same quantity. \hfill\hyperlink{src:spine1}{\beamerreturnbutton{Back to the margin}}
\end{frame}
