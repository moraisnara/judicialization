...
\begin{itemize}\itemsep3pt
  ...
  \item \textbf{Representa\c{c}\~ao} \ns{(Lei 9.504)}: campaign-conduct violations, including illicit fundraising (art.~30-A), vote-buying (art.~41-A) and misuse of office (art.~73).
  \item \textbf{Propaganda / right of reply} \ns{(arts.~96, 58)}: irregular campaign advertising, with the offended side answering.
