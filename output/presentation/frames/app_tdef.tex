...
\end{columns}
\smallskip
{\centering\scriptsize Existence, sign, and significance of the consolidation are robust to the treatment definition, while the per-unit magnitude is definition-dependent (Chen--Roth 2023). That is why the reduced form, rather than a units-laden 2SLS coefficient, is the object we treat as the headline.\par}
\smallskip
