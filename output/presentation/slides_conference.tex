...
\begin{tabular}{L{3.0cm}rrrr}
  \toprule
  Specification & Coef. & SE & $t$ & F \\
  \midrule
  Baseline          & 1.791 & 0.405 & 4.43 & \textbf{19.6} \\
  Single-zone       & 1.801 & 0.422 & 4.27 & \textbf{18.2} \\
  Extended controls & 1.799 & 0.406 & 4.44 & \textbf{19.7} \\
  Broader treatment & 1.792 & 0.405 & 4.43 & \textbf{19.6} \\
  \bottomrule
  \multicolumn{5}{l}{\scriptsize $N$\,=\,5,560 (baseline/extended/broader); 5,371 (single-zone).}
\end{tabular}
\normalsize
\smallskip
\footnotesize Coef.\ $\hat\beta \approx 1.8$ and $F > 18$ across all specifications.\normalsize
\end{column}
